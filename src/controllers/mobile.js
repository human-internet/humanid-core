...
class MobileController extends BaseController {
    ...
    route = () => {
        ...
        router.get(
            "/users/login",
            [this.handleValidateAppCred, this.handleValidateAppUserCred],
            this.handleCheckAppUserAccess
        );
         ...
         * @apiUse ErrorResponse
         */
        router.put("/users", [this.handleValidateAppCred, this.handleValidateAppUserCred], this.handleUpdate);
