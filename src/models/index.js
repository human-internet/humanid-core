...
const App = require("./app"),
    ...
    DevConsoleClient = require("./dev-console-client"),
    TopupHistories = require("./topup-history"),
...
db.DevConsoleClient = DevConsoleClient(sequelize);
...
db.TopupHistories = TopupHistories(sequelize);
