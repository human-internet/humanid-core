...
config.ASSETS_DIR = process.env.ASSETS_DIR || config.ASSETS_DIR || path.join(config.WORK_DIR, '/public')
...
// Client.WebLogin
config.WEB_LOGIN_URL = process.env.WEB_LOGIN_URL || config.WEB_LOGIN_URL || 'https://web-login.human-id.org/login'
